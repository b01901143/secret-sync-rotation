...
func (o *options) Validate() error {
	...
	if o.rotConfigPath == "" {
		return fmt.Errorf("required flag --rot-config was unset")
	}
	return nil
}
...
func gatherOptions() options {
	...
	flag.StringVar(&o.syncConfigPath, "sync-config", "", "Path to sync-config.yaml.")
	flag.StringVar(&o.rotConfigPath, "rot-config", "", "Path to rot-config.yaml.")
